      ...
      <div id="rightcolumn">
        ...
        <?php
          ...
          if ($_GET['error']=='incorrect'){
            print "<div style='color:red;'><strong>Your username and/or password are incorrect!</strong></div>";
          }
          else if ($_GET['error']=='missinginfo'){
            print "<div style='color:red;'><strong>Username/Password is missing!</strong></div>";

          }

          if($_GET['action']=='loggedout'){
            print "<div style='color:red;'><strong>You are logged out!</strong></div>";
          }

          if($_GET['confirmation']=='savedtext'){
            print "<div style='color:red;'><strong>The change has been saved!</strong></div>";
          }
        ...
        <div id="content">
          ...
          <?php
            ...
            if ($_COOKIE['loggedin'] == 'yes') {
              ...
              $policytext = file_get_contents($file_path.'/policies.txt');
              ...
              <form method="post" action="savetext.php">
                ...
                Policypage Text:
                <textarea name="policypage"><?php print $policytext; ?></textarea>
                Alert Text:
                <textarea name="alertmessage"><?php print $alerttext; ?></textarea>
                <input type="submit">
              </form>
